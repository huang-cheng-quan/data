...
namespace Camera_Capture_demo.Helpers
{
    ...
    public class LogHelper
    {
        ...
        /// 日志在主窗口显示
        /// </summary>
        public delegate void LogDispHandler(string msg,string level);
        public static event LogDispHandler LogDisp;

        private static void OnLogDisp(string msg,string level)
        {
            if (LogDisp != null)
            {
                LogDisp(msg,level);
        ...
        //public class LogDispEventArgs : EventArgs
        //{
        //    public readonly string logMsg;

        //    public LogDispEventArgs(string logMsg)
        //    {
        //        this.logMsg = DateTime.Now.ToString("yyyy/MM/dd HH:mm:ss") + "\t" + logMsg;
        //    }
        //}
    }
}